...
module Spree
  describe Api::V1::ProductsController, type: :controller do
    ...
    let!(:inactive_product) { create(:product, available_on: Time.current.tomorrow, name: 'inactive', stores: [store], status: :draft) }
    ...
    context 'as an admin' do
      ...
      describe 'creating a product' do
        ...
        context 'with authentication_required set to false' do
          before do
            Spree::ApiV1::Config.requires_authentication = false
          end

          after do
            Spree::ApiV1::Config.requires_authentication = true
          end
