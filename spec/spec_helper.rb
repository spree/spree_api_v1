...
require 'spree/api_v1/testing_support/setup'
require 'spree/api_v1/testing_support/helpers'
...
RSpec.configure do |config|
  ...
  config.include Spree::ApiV1::TestingSupport::Helpers, type: :controller
  config.include Spree::ApiV1::TestingSupport::Helpers, type: :request
  config.extend Spree::ApiV1::TestingSupport::Setup, type: :controller
